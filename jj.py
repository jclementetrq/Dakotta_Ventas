...
def escribir_log(mensaje,
                 archivo_log="C:\\Users\\Administrador\\OneDrive - TRACTOMAQ S.A\\Escritorio\\LOGS GIT JC\\LOGMEDIDOR1\\log.txt"):
...
def guardar_consolidado(df1, df2, nombre_archivo, hoja1, hoja2, desde_columna_monedas=3):
    ...
    ajustar_ancho_columnas(nombre_archivo, hoja1, desde_columna_monedas)
    ajustar_ancho_columnas(nombre_archivo, hoja2, desde_columna_monedas)

    formatear_columnas_dolares(nombre_archivo, hoja1, desde_columna_monedas)
    formatear_columnas_dolares(nombre_archivo, hoja2, desde_columna_monedas)
...
if __name__ == "__main__":
    ...
    guardar_consolidado(df_hoja1, df_hoja2, nombre_consolidado, hoja1="VENTAS POR GRUPO", hoja2="VENTA MENSUAL")
